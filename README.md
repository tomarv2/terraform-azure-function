...
| <a name="input_function_app_name"></a> [function\_app\_name](#input\_function\_app\_name) | Function app name | `string` | `null` | no |
| <a name="input_function_enable_logging"></a> [function\_enable\_logging](#input\_function\_enable\_logging) | Function enable logging | `bool` | `true` | no |
| <a name="input_function_enabled"></a> [function\_enabled](#input\_function\_enabled) | Function enabled | `bool` | `true` | no |
| <a name="input_function_https_only"></a> [function\_https\_only](#input\_function\_https\_only) | Function https only | `bool` | `false` | no |
| <a name="input_function_os_type"></a> [function\_os\_type](#input\_function\_os\_type) | Operating System of the function | `string` | `"linux"` | no |
| <a name="input_function_version"></a> [function\_version](#input\_function\_version) | Function version | `string` | `"~3"` | no |
